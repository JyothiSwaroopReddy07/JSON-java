...
public class XMLTest {
  ...
  @Test
    public void testSimpleJSONObjectStream() {
    ...
    @Test
    public void testNestedJSONObjectStream() {
    ...
    @Test
    public void testLeafStreamOnly() {
        JSONObject address = new JSONObject();
        address.put("street", "123 Main St");
        address.put("city", "New York");
    ...
    @Test
    public void testFlatStreamOnly() {
        JSONObject address = new JSONObject();
        address.put("street", "123 Main St");
        address.put("city", "New York");
    ...
    public void testComplexXML() throws Exception {
        ...
        // Extract all city names - handle the fact that they're stored as {"content": "city name"}
        ...
        // Calculate average age - handle the fact that ages are also stored as {"content": "30"}
